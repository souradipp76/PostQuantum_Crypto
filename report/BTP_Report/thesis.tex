...
\include{preliminaries}       % Chapter 2: Introduction
\include{literature}          % Chapter 3: Literature survey
\include{system}              % Chapter 4: System model and formulating the problem statement
\include{progress}           % Chapter 4: Analysis
\include{future}             % Chapter 5: Simulation and Results
