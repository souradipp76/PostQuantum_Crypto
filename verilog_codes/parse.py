...
expr1 = "0-(2*(((L3^2)*(m3^2)*sin(2*x(1)-2*x(3))*(4*I2-(L2^2)*m2)+(L2^2)*sin(2*x(1)-2*x(2))*(m2+2*m3)*(m2*m3*(L3^2)+4*I3*(m2+2*m3)))*(L1^2)*(x(4)^2)+(L2*(sin(x(1)-x(2))*((m2*m3*(m2+3*m3)*(L3^2)+4*I3*((m2^2)+6*m2*m3+8*(m3^2)))*(L2^2)+4*I2*(m3*(m2+m3)*(L3^2)+4*I3*(m2+2*m3)))+(L3^2)*(m3^2)*sin(x(1)+x(2)-2*x(3))*(4*I2-(L2^2)*m2))*(x(5)^2)-4*k2*L2*(cos(x(1)-x(2))*(m3*(m2+m3)*(L3^2)+4*I3*(m2+2*m3))-(L3^2)*(m3^2)*cos(x(1)+x(2)-2*x(3)))*(x(5)^2)+L3*m3*(sin(x(1)-x(3))*(8*I3*m3*(L2^2)+4*I2*m3*(L3^2)+16*I2*I3)+(L2^2)*sin(x(1)-2*x(2)+x(3))*(m2*m3*(L3^2)+4*I3*(m2+2*m3)))*(x(6)^2)-4*k3*L3*m3*(cos(x(1)-x(3))*(2*m3*(L2^2)+4*I2)-(L2^2)*cos(x(1)-2*x(2)+x(3))*(m2+2*m3))*x(6)-g*(sin(x(1))*((m3*(m1*m2+2*m1*m3+3*m2*m3+(m2^2))*(L3^2)+4*I3*((m2^2)+6*m2*m3+m1*m2+4*(m3^2)+4*m1*m3))*(L2^2)+4*I2*(m3*(m1+2*m2+m3)*(L3^2)+4*I3*(m1+2*m2+2*m3)))+(L3^2)*(m3^2)*(sin(x(1)-2*x(3))*(4*I2-(L2^2)*m2)-2*(L2^2)*cos(2*x(2)-2*x(3))*sin(x(1))*(m1+m2))+(L2^2)*sin(x(1)-2*x(2))*(m2+2*m3)*(m2*m3*(L3^2)+4*I3*(m2+2*m3))))*L1+2*k1*(4*I2*(m3*(L3^2)+4*I3)+(L2^2)*(m3*(m2+2*m3)*(L3^2)+4*I3*(m2+4*m3))-2*(L2^2)*(L3^2)*(m3^2)*cos(2*x(2)-2*x(3)))*x(1)))/(64*I1*I2*I3+8*I3*(L1^2)*(L2^2)*(m2^2)+8*I1*(L2^2)*(L3^2)*(m3^2)+8*I2*(L1^2)*(L3^2)*(m3^2)+32*I3*(L1^2)*(L2^2)*(m3^2)+16*I2*I3*(L1^2)*m1+16*I1*I3*(L2^2)*m2+64*I2*I3*(L1^2)*m2+16*I1*I2*(L3^2)*m3+64*I1*I3*(L2^2)*m3+64*I2*I3*(L1^2)*m3+4*I3*(L1^2)*(L2^2)*m1*m2+4*I2*(L1^2)*(L3^2)*m1*m3+16*I3*(L1^2)*(L2^2)*m1*m3+4*I1*(L2^2)*(L3^2)*m2*m3+16*I2*(L1^2)*(L3^2)*m2*m3+48*I3*(L1^2)*(L2^2)*m2*m3-8*I1*(L2^2)*(L3^2)*(m3^2)*cos(2*x(2)-2*x(3))-2*(L1^2)*(L2^2)*cos(2*x(1)-2*x(2))*(m2+2*m3)*(m2*m3*(L3^2)+4*I3*(m2+2*m3))-2*(L1^2)*(L3^2)*(m3^2)*cos(2*x(1)-2*x(3))*(-m2*(L2^2)+4*I2)+2*(L1^2)*(L2^2)*(L3^2)*m1*(m3^2)+6*(L1^2)*(L2^2)*(L3^2)*m2*(m3^2)+2*(L1^2)*(L2^2)*(L3^2)*(m2^2)*m3+(L1^2)*(L2^2)*(L3^2)*m1*m2*m3-2*(L1^2)*(L2^2)*(L3^2)*m1*(m3^2)*cos(2*x(2)-2*x(3))-4*(L1^2)*(L2^2)*(L3^2)*m2*(m3^2)*cos(2*x(2)-2*x(3)))"
expr2 = "(2*(((L1^2)*sin(2*x(1)-2*x(2))*(m2+2*m3)*(m2*m3*(L3^2)+4*I3*(m2+2*m3))-(L3^2)*(m3^2)*sin(2*x(2)-2*x(3))*((m1+2*m2)*(L1^2)+4*I1))*(L2^2)*(x(5)^2)+L1*(sin(x(1)-x(2))*((m3*(m1*(m2+m3)+2*m2*(2*m2+3*m3))*(L3^2)+4*I3*(m2+2*m3)*(m1+4*m2+4*m3))*(L1^2)+4*I1*(m3*(m2+m3)*(L3^2)+4*I3*(m2+2*m3)))-(L3^2)*(m3^2)*sin(x(1)+x(2)-2*x(3))*((m1+2*m2)*(L1^2)+4*I1))*L2*(x(4)^2)+4*k1*L1*(cos(x(1)-x(2))*(m3*(m2+m3)*(L3^2)+4*I3*(m2+2*m3))-(L3^2)*(m3^2)*cos(x(1)+x(2)-2*x(3)))*L2*x(4)+(-L3*m3*(sin(x(2)-x(3))*((m3*(m1+3*m2)*(L3^2)+4*I3*(m1+3*m2+2*m3))*(L1^2)+4*I1*(m3*(L3^2)+4*I3))-(L1^2)*sin(2*x(1)-x(2)-x(3))*(m2*m3*(L3^2)+4*I3*(m2+2*m3)))*(x(6)^2)+4*k3*L3*m3*(cos(x(2)-x(3))*((m1+3*m2+2*m3)*(L1^2)+4*I1)-(L1^2)*cos(2*x(1)-x(2)-x(3))*(m2+2*m3))*x(6)+g*(sin(x(2))*((m2*m3*(2*m2+3*m3)*(L3^2)+8*I3*((m2^2)+3*m2*m3+2*(m3^2)))*(L1^2)+4*I1*(m3*(m2+m3)*(L3^2)+4*I3*(m2+2*m3)))-(L1^2)*sin(2*x(1)-x(2))*(m3*(m1*(m2+m3)+m2*(2*m2+3*m3))*(L3^2)+4*I3*(m2+2*m3)*(m1+2*m2+2*m3))+(L3^2)*(m3^2)*(sin(x(2)-2*x(3))*(m2*(L1^2)+4*I1)+(L1^2)*sin(2*x(1)+x(2)-2*x(3))*(m1+m2))))*L2-2*k2*(4*I1*(m3*(L3^2)+4*I3)+(L1^2)*(m3*(m1+4*m2+2*m3)*(L3^2)+4*I3*(m1+4*m2+4*m3))-2*(L1^2)*(L3^2)*(m3^2)*cos(2*x(1)-2*x(3)))*(x(5)^2)))/(64*I1*I2*I3+8*I3*(L1^2)*(L2^2)*(m2^2)+8*I1*(L2^2)*(L3^2)*(m3^2)+8*I2*(L1^2)*(L3^2)*(m3^2)+32*I3*(L1^2)*(L2^2)*(m3^2)+16*I2*I3*(L1^2)*m1+16*I1*I3*(L2^2)*m2+64*I2*I3*(L1^2)*m2+16*I1*I2*(L3^2)*m3+64*I1*I3*(L2^2)*m3+64*I2*I3*(L1^2)*m3+4*I3*(L1^2)*(L2^2)*m1*m2+4*I2*(L1^2)*(L3^2)*m1*m3+16*I3*(L1^2)*(L2^2)*m1*m3+4*I1*(L2^2)*(L3^2)*m2*m3+16*I2*(L1^2)*(L3^2)*m2*m3+48*I3*(L1^2)*(L2^2)*m2*m3-8*I1*(L2^2)*(L3^2)*(m3^2)*cos(2*x(2)-2*x(3))-2*(L1^2)*(L2^2)*cos(2*x(1)-2*x(2))*(m2+2*m3)*(m2*m3*(L3^2)+4*I3*(m2+2*m3))-2*(L1^2)*(L3^2)*(m3^2)*cos(2*x(1)-2*x(3))*(-m2*(L2^2)+4*I2)+2*(L1^2)*(L2^2)*(L3^2)*m1*(m3^2)+6*(L1^2)*(L2^2)*(L3^2)*m2*(m3^2)+2*(L1^2)*(L2^2)*(L3^2)*(m2^2)*m3+(L1^2)*(L2^2)*(L3^2)*m1*m2*m3-2*(L1^2)*(L2^2)*(L3^2)*m1*(m3^2)*cos(2*x(2)-2*x(3))-4*(L1^2)*(L2^2)*(L3^2)*m2*(m3^2)*cos(2*x(2)-2*x(3)))"
...
# print(sz)
for k in range(sz):
    print('11\'b{0:011b}: data <= 8\'h'.format(k)+pstfix_binary[k]+";")
